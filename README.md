...
- **기출문제 풀이**: 연도별 기출문제를 1차/2차 전체 또는 과목별(학개론 · 민법 · 중개사법령 · 공법 · 공시법&세법)로 선택해 풀이 및 채점
- **기출문제 풀이 조회**: 지난 풀이 기록 확인
- **공법 퀴즈**: 부동산공법 이지선다 116문항을 법 제목별(국토계획법 35 · 도시개발법 17 · 도시정비법 17 · 건축법 20 · 주택법 21 · 농지법 6)로 골라 드롭다운으로 풀이·채점, 틀린 문항만 다시 풀기
